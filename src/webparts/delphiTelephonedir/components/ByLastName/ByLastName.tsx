...
export class ByLastName extends React.Component<ByLastNameProps, ByLastNameState>{
  constructor(props: ByLastNameProps) {
    ...
    this.searchUsersError = this.searchUsersError.bind(this);
  }

  //  @autobind
  public async searchUsers(event: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>, newValue?: string): Promise<void> {
    try {
      this.setState({
        searchFor: newValue,
      });
